// All types self-contained here — no monorepo root dependency needed for deployment.
...
export interface ToastMessage {
  id: string;
  type: 'info' | 'success' | 'error' | 'warning' | 'chaos';
  message: string;
  duration?: number;
}
...
export const COLOR_OPTIONS = [
  ...
  '#EF4444', '#3B82F6', '#F97316', '#8B5CF6', '#14B8A6',
];

export interface PersonalGameData {
  currentWord: string;
